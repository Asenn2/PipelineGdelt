1 ----->docker compose up -d -> ay lanci kolchi flow nifi kayn, grafana fih les visualisation li wselt lihom , spark fih deja les script d'ingestion. 2 -----> docker logs -f nifi -> nifi ki t3etel diro had commande bach tchofo wach dkchi tlanca
